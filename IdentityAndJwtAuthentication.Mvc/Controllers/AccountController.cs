...
using IdentityAndJwtAuthentication.Models.AccountViewModels;
...
namespace IdentityAndJwtAuthentication.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		#region Login with Json Web Token

		[HttpGet]
		[AllowAnonymous]
		public async Task<IActionResult> LoginWithJwt(string returnUrl = null)
		{
			// Return login view for Jwt login for test purpose.
			// Clear the existing external cookie to ensure a clean login process
			await HttpContext.SignOutAsync(IdentityConstants.ExternalScheme);
